//
//  UIImage+SQCWebViewControllerIcons.m
//  YaoFang
//
...
const NSString *SQCWebViewControllerButtonTintColor       = @"SQCWebViewControllerButtonFillColor";
const NSString *SQCWebViewControllerButtonBevelOpacity    = @"SQCWebViewControllerButtonBevelOpacity";
...
@implementation UIImage (SQCWebViewControllerIcons)

#pragma mark - Private Methods -
+ (UIColor *)fillColorFromAttributes:(NSDictionary *)attributes
{
    UIColor *fillColor = attributes[SQCWebViewControllerButtonTintColor];
    if (fillColor == nil) {
        if (IPAD)
...
+ (CGFloat)bevelOpacityFromAttributes:(NSDictionary *)attributes
{
    NSNumber *opacityNumber = attributes[SQCWebViewControllerButtonBevelOpacity];
