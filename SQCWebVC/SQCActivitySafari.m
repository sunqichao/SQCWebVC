...
NSString *const SQCActivityTypeSafari = @"au.com.timoliver.SQCActivityTypeSafari";
...
@implementation SQCActivitySafari

#pragma mark - Activity Display Properties -
- (NSString *)activityType
{
    return SQCActivityTypeSafari;
}
...
{
    return [SQCActivitySafari sharedActivityImage];
}
